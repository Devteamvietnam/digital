...
import com.devteam.util.bean.BeanInspector;
...
public class SqlUtil {
  ...
  static public ClauseFilter createShareableClause(Class<?> entity) {
    ...
    = new ClauseFilter(entity, "shareable", "=", ":privateShareable")
      .AND(entity, "createdBy", "=", ":loginId");

    ClauseFilter accountFilter
    = new ClauseFilter(entity, "shareable", "=", ":accountShareable");

    ClauseFilter descendantFilter
    = new ClauseFilter(entity, "shareable", "=", ":desShareable");

    return privateFilter.OR(accountFilter).OR(descendantFilter)
          .OR(entity, "shareable", "=", ":orgShareable");
  }
}
