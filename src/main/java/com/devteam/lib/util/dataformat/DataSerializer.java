...
public class DataSerializer {
    final static public Charset UTF_8 =  StandardCharsets.UTF_8;
    ...
    static public <T> T jsonClone(Class<T> type, T obj) {
        return JSON.clone(type, obj);
    }

    static public <T> T jsonClone(T obj) {
