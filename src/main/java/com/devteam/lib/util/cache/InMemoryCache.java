package com.devteam.lib.util.cache;
...
public class InMemoryCache<T> implements Cache<T> {
    ...
    private static final AtomicLong idTracker = new AtomicLong();
    private static final CleanerThread CLEANER_THREAD = new CleanerThread();
