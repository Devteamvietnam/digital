...
/**
 * @description Rsa Tools, public key and private key generation, encryption and decryption
 **/
public class RsaUtils {
    ...
    private static void test1(RsaKeyPair keyPair) throws Exception {
        ...
        if (RsaUtils.SRC.equals(text2)) {
            ...
            System.out.println("The decrypted string is inconsistent with the original string, and the decryption fails");
        }
    ...
    private static void test2(RsaKeyPair keyPair) throws Exception {
        ...
        if (RsaUtils.SRC.equals(text2)) {
            ...
            System.out.println("The decrypted string is inconsistent with the original string, decryption failed");
        }
        System.out.println("***************** The end of private key encryption and public key decryption*****************") ;
    }
