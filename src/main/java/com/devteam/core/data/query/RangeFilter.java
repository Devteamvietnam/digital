...
public class RangeFilter extends FieldFilter {
  ...
  static public <T extends BaseEntity<Long>> RangeFilter createdTime(Class<T> entity) {
    return new RangeFilter(entity,  "createdTime").type(FilterType.Date);
  }

  static public <T extends BaseEntity<Long>> RangeFilter modifiedTime(Class<T> entity) {
    return new RangeFilter(entity,  "modifiedTime").type(FilterType.Date);
  }

  static public <T extends BaseEntity<Long>> RangeFilter date(Class<T> entity, String field) {
