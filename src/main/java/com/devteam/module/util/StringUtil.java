...
import com.devteam.module.error.ErrorType;
import com.devteam.module.error.RuntimeError;
...
public class StringUtil {
    ...
    static public List<String> split(String string, char separator) {
        char[] buf = string.toCharArray() ;
        return split(buf, separator) ;
    }

    static public List<String> split(String string, String ... separator)  {
    ...
    static public List<String> split(String string, String[] separator, boolean includeSeparator) {
        List<String> holder = new ArrayList<String>() ;
